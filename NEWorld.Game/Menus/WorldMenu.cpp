    ...
    private:
        ...
        void onUpdate() override {
            ...
            if (deletebtn.clicked) {
                //删除世界文件
                NEWorld::filesystem::remove_all("./Worlds/" + chosenWorldName + '/');
            ...
            if (refresh) {
                ...
                for (auto &&x : NEWorld::filesystem::directory_iterator("./Worlds/")) {
                    if (NEWorld::filesystem::is_directory(x)) {
        ...
        void onRender() override {
            ...
            UIVertex(midp - 250, 48 + i * 64 + 60);
            glEnd();
            TextRenderer::renderString(static_cast<int>(windowwidth / stretch -
                                                        TextRenderer::getStrWidth(GetStrbyKey("NEWorld.worlds.new"))) /
                                       2,
