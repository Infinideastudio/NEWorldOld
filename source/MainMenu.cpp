...
namespace Menus {
	...
	private:
		...
		void onLoad() {
			...
			startbtn = GUI::button(GetStr(0), -200, 200, 280, 312, 0.5, 0.5, 0.0, 0.0);
			optionsbtn = GUI::button(">> "+GetStr(1)+"...", -200, -3, 318, 352, 0.5, 0.5, 0.0, 0.0);
			quitbtn = GUI::button(GetStr(2) , 3, 200, 318, 352, 0.5, 0.5, 0.0, 0.0);
