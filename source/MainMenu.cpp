...
namespace Menus {
	...
	private:
		...
		void onLoad() {
			...
			startbtn = GUI::button(GetStrbyKey("gui:Start"), -200, 200, 280, 312, 0.5, 0.5, 0.0, 0.0);
			optionsbtn = GUI::button(">> "+GetStrbyKey("gui:Options")+"...", -200, -3, 318, 352, 0.5, 0.5, 0.0, 0.0);
			quitbtn = GUI::button(GetStrbyKey("gui:Exit") , 3, 200, 318, 352, 0.5, 0.5, 0.0, 0.0);
