...
private:
	...
	int trs = 0;
			...
			void onLoad()
			{
				title = UI::Label("==============<  选 择 世 界  >==============", -225, 225, 20, 36, 0.5, 0.5, 0.0, 0.0);
				vscroll = UI::vscroll(100, 0, 275, 295, 36, -20, 0.5, 0.5, 0.0, 1.0);
				enterbtn = UI::button("进入选定的世界", -250, -10, -80, -56, 0.5, 0.5, 1.0, 1.0);
				deletebtn = UI::button("删除选定的世界", 10, 250, -80, -56, 0.5, 0.5, 1.0, 1.0);
				backbtn = UI::button("<< 返回主菜单", -250, 250, -44, -20, 0.5, 0.5, 1.0, 1.0);
