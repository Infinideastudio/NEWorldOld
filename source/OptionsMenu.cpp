...
namespace InfinideaStudio
{
	namespace NEWorld
	{
		...
		private:
			...
			void onLoad()
			{
				title = UI::Label("=================<  选 项  >=================", -225, 225, 20, 36, 0.5, 0.5, 0.0, 0.0);
				FOVyBar = UI::trackbar(strWithVar("视野角度：", FOVyNormal), 120, (int) (FOVyNormal - 1), -250, -10, 60, 84, 0.5, 0.5, 0.0, 0.0);
				mmsBar = UI::trackbar(strWithVar("鼠标灵敏度：", mousemove), 120, (int) (mousemove * 40 * 2 - 1), 10, 250, 60, 84, 0.5, 0.5, 0.0, 0.0);
				viewdistBar = UI::trackbar(strWithVar("渲染距离：", viewdistance), 120, (viewdistance - 2) * 4 - 1, -250, -10, 96, 120, 0.5, 0.5, 0.0, 0.0);
				rdstbtn = UI::button(">> 渲染选项...", -250, -10, 204, 228, 0.5, 0.5, 0.0, 0.0);
				gistbtn = UI::button(">> 图形界面选项...", 10, 250, 204, 228, 0.5, 0.5, 0.0, 0.0);
				backbtn = UI::button("<< 返回主菜单", -250, -10, -44, -20, 0.5, 0.5, 1.0, 1.0);
				savebtn = UI::button("保存设置", 10, 250, -44, -20, 0.5, 0.5, 1.0, 1.0);
