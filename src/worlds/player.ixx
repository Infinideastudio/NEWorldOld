...
public:
    ...
    Vec3d lookCoord() const {
        return {position.x, position.y + height + heightExt, position.z};
    }
...
private:
    ...
    Hitbox::AABB playerbox = {-0.3, 0.3, -0.85, 0.85, -0.3, 0.3};
...
void Player::updateHitbox() {
    Hitbox::MoveTo(playerbox, position.x, position.y + 0.5, position.z);
}
